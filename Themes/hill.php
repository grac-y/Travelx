...
<head>
    ...
    <title>Hill Station Tour Packages</title>
    <style>
        .inner_banner .introduction .banner_image {
            background: url(../Images/Hill/animation1.jpg);
        ...
        @keyframes slider {
            ...
            25% {
                background: url(../Images/Hill/animation2.jpg);
                background-size: 100% 100%;
            }

            50% {
                background: url(../Images/Hill/animation3.jpg);
                background-size: 100% 100%;
            }

            75% {
                background: url(../Images/Hill/animation4.jpg);
                background-size: 100% 100%;
            }
        }
    </style>
...
<body>
    ...
    <div class="tour_card_container">
        <?php
        $sql = "SELECT * from destinations where id = 10 ";
